  ...
  return (
      <div className={`${style.burgerMenu}  ${props.isOpen ? style.show : style.close}` }>
          ...
          <div className={style.burgerHeader}>
            <span className={style.langRu}>RU</span>
         ...
         <div className={style.burgerMain}>
           ...
           <button className={style.searchBtn}>Найти номер</button>

           <div className={style.menuMini}>
             <div className={style.menuMiniItem}>
             ...
             <div className={style.menuMiniItem}>
              ...
              <NavLink to="/">Спецпредложения</NavLink>
             </div>
             
             <div className={style.menuMiniItem}>
              <NavLink to="/">Важная информация</NavLink>
              <NavLink to="/">Контакты</NavLink>
             </div>
           </div>
           
           <div className={style.socialMini}>
               <div className={style.socialWrapper}>
               <NavLink to="/" className={style.socialItem}>
                    <svg width="12" height="18" viewBox="0 0 12 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.6688 10H7V18H3V10H0V7H3V4.53906C3 3.60156 3 2.5 4 1.5C5 0.5 6.37591 0 8.18796 0C10
         ...
         <div className={style.phone}>8 800 500 6847</div>
